...
public struct ServerUnreadConversationListItem: Codable, Hashable, Sendable {
...
extension ServerUnreadConversationListItem {
    public static func == (lhs: ServerUnreadConversationListItem, rhs: ServerUnreadConversationListItem) -> Bool {
