...
class ChatAPIManager {
    ...
    func openBatch(type: String, batchId: String, participants: [String], conversationId: String? = nil) async throws {
    ...
    func closeBatch(batchId: String) async throws {
    ...
    func patchMessage(batchId: String, messageId: String, newText: String) async throws -> [String: Any] {
    ...
    func getHistory(conversationId: String) async throws -> [ServerBatchDocument] {
